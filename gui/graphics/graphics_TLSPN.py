...
class GraphManagerTLSPN():
	...
	def add_place(self, place, x, y):
		...
		place_graph_item = GraphPlaceItemTLSPN(place, x, y)
	...
	def add_transition(self, transition, x, y, orientation=0):
		...
		transition_graph_item = GraphTransitionItemTLSPN(transition, x, y, orientation)
	...
	def add_arc(self, arc, source_item, target_item):
		...
		if can_create:
			...
			arc_graph_item = GraphArcItemTLSPN(arc, source_item, target_item)
...
class GraphArcItemTLSPN(QGraphicsLineItem):
